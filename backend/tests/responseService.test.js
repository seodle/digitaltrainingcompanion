...
describe('Create Reponses', () => {
    ...
    test('get responses from assessment', async () => {
        ...
        for (const assessment of assessments) {
            ...
            const responses = await ResponseService.getAnswersFromAssessmentId(assessment._id);
            ...
            responses.forEach(response => {
                ...
                expect(monitoring._id).toStrictEqual(response.monitoringId._id);
                expect(assessment._id).toStrictEqual(response.assessmentId._id);
