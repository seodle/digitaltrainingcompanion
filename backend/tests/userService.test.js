...
describe('User Service', () => {
    ...
    test('appendSharingCodeToUser appends a new sharing code', async () => {
        ...
        const result = await UserService.startFollowingMonitoring(userId, sharingCode);
    ...
    test('appendSharingCodeToUser fails if sharing code does not exist', async () => {
        ...
        const result = await UserService.startFollowingMonitoring(userId, "ABCD132");
        expect(result).toBeDefined();
    ...
    test('appendSharingCodeToUser does not append a duplicate code', async () => {
        ...
        const result1 = await UserService.startFollowingMonitoring(userId, monitoring.sharingCode);  // Append once
        const result2 = await UserService.startFollowingMonitoring(userId, monitoring.sharingCode); // Try to append again
