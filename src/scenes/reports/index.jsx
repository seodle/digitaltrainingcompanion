...
const Reports = () => {
    ...
    useEffect(() => {
        const fetchLastResponse = async () => {
            ...
            try {
                const response = await axios.get(`${BACKEND_URL}/responses/last/${currentUser._id}`, {
                    headers: { Authorization: `Bearer ${token}` }
                });
                ...
                if (response.data) {
                    ...
                    if (monitoring) {
                        ...
                        const assessmentsResponse = await axios.get(`${BACKEND_URL}/assessments/${monitoringId}`, {
                            headers: { Authorization: `Bearer ${token}` }
                        });
    ...
    const generateAiSummary = async (responses, questionText, questionKey) => {
        ...
        try {
            ...
            const response = await axios.post(
                `${BACKEND_URL}/api/generate-text-summary`,
                { 
