    ...
    return (
        <Box display="flex" sx={{ minHeight: '100vh', overflow: 'auto', maxWidth: '100vw', bgcolor: '#f9f9f9' }}>
            ...
            <Box display="flex" flex="1" flexDirection="column" sx={{ minWidth: 0 }}>
                ...
                {/* User Info Section */}
                <Box mt="20px" mx={{ xs: 3, md: "20px" }} p={{ xs: 2, md: "20px" }} border="1px solid #ccc" borderRadius="8px" bgcolor={veryLightGray} sx={{ overflowX: "auto", wordBreak: "break-word" }}>
                ...
                <Box display="flex" flexWrap="wrap" gap="20px" alignItems="stretch" mt="20px" mx={{ xs: 3, md: "20px" }}>
                    {/* API Keys Section */}
                    <Box flex="1 1 280px" p={{ xs: 2, md: "20px" }} border="1px solid #ccc" borderRadius="8px" bgcolor={veryLightGray} sx={{ minWidth: 0, overflowX: "auto" }}>
