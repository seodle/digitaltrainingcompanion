...
2.2 Alcune funzionalità potrebbero richiedere la creazione di un account utente.
2.3 Gli account in modalità "sandbox" sono account temporanei che possono essere eliminati 
in qualsiasi momento senza preavviso. Gli utenti di questi account accettano il loro carattere 
...
Questi dati sono raccolti e trattati esclusivamente per scopi di autenticazione sul sito.

5.3 Periodo di conservazione
I dati personali sono conservati a tempo indeterminato o fino alla richiesta di 
cancellazione da parte dell'utente.

5.4 Diritti degli utenti
In conformità con la legislazione svizzera sulla protezione dei dati e il GDPR, gli utenti 
...
salvare un token di autenticazione strettamente necessario per il corretto funzionamento 
del sito. Questo archivio mantiene attiva la sessione utente.

5.6 Servizi di terze parti e trasferimento dei dati
Il sito utilizza gli strumenti AI di Infomaniak per alcune funzionalità. Ciò implica:
- La trasmissione di alcuni dati ai server di Infomaniak
- Il trasferimento dei dati ai server di Infomaniak in Svizzera
- L'elaborazione dei dati secondo i termini di utilizzo di Infomaniak

I servizi AI di Infomaniak garantiscono la totale riservatezza dei dati. Secondo la loro 
politica, nessun dato inviato tramite API viene memorizzato o utilizzato per formazione 
o analisi. L'elaborazione dei dati avviene in tempo reale, esclusivamente su server 
situati in Svizzera, in infrastrutture certificate ISO 27001. Infomaniak si impegna a 
rispettare il GDPR e la legislazione svizzera sulla protezione dei dati.

5.7 Account sandbox
Per gli account sandbox, i dati possono essere eliminati in qualsiasi momento senza preavviso.`,

                article6Title: "Articolo 6: Obblighi degli utenti",
                article6Text: `Gli utenti si impegnano a:
- Non disturbare il funzionamento del sito
- Non tentare di accedere a parti non autorizzate del sito
...
- Fornire un contatto per qualsiasi domanda relativa all'interruzione del servizio

9.2 La notifica di interruzione sarà effettuata via email agli utenti registrati e 
mediante avviso sul sito.`,

                article10Title: "Articolo 10: Legge applicabile e giurisdizione competente",
                article10Text: `10.1 I presenti TGU sono soggetti al diritto svizzero.
...
2.2 Algunas funcionalidades pueden requerir la creación de una cuenta de usuario.
2.3 Las cuentas en modo "sandbox" son cuentas temporales que pueden ser eliminadas en 
cualquier momento sin previo aviso. Los usuarios de estas cuentas aceptan su carácter 
...
Estos datos se recogen y tratan únicamente para fines de autenticación en el sitio.

5.3 Periodo de conservación
Los datos personales se conservan sin límite de tiempo o hasta la solicitud de 
eliminación por parte del usuario.

5.4 Derechos de los usuarios
De acuerdo con la legislación suiza de protección de datos y el RGPD, los usuarios 
...
para guardar un token de autenticación estrictamente necesario para el correcto 
funcionamiento del sitio. Este almacenamiento mantiene activa la sesión del usuario.

5.6 Servicios de terceros y transferencia de datos
El sitio utiliza las herramientas AI de Infomaniak para ciertas funcionalidades. Esto implica:
- La transmisión de algunos datos a los servidores de Infomaniak
- La transferencia de datos a servidores de Infomaniak en Suiza
- El tratamiento de datos según las condiciones de uso de Infomaniak

Los servicios AI de Infomaniak garantizan total confidencialidad de los datos. Según su 
política, ningún dato enviado vía API es almacenado o utilizado para entrenamiento o 
análisis. El procesamiento de datos se realiza en tiempo real, exclusivamente en 
servidores ubicados en Suiza, en infraestructuras certificadas ISO 27001. Infomaniak 
se compromete a cumplir con el RGPD y la legislación suiza de protección de datos.

5.7 Cuentas sandbox
Para las cuentas sandbox, los datos pueden ser eliminados en cualquier momento sin previo aviso.`,

                article6Title: "Artículo 6: Obligaciones de los usuarios",
                article6Text: `Los usuarios se comprometen a:
- No perturbar el funcionamiento del sitio
- No intentar acceder a partes no autorizadas del sitio
...
- Proporcionar un contacto para cualquier pregunta relacionada con la interrupción del servicio

9.2 La notificación de interrupción se realizará por correo electrónico a los usuarios 
registrados y mediante aviso en el sitio.`,

                article10Title: "Artículo 10: Ley aplicable y jurisdicción competente",
                article10Text: `10.1 Los presentes TGU se rigen por el derecho suizo.
